...
<div class="row">
    <div class="col-md-12" style="float:right">
        <a href="{{url('create-salary')}}" class="btn btn-success btn-sm" style="float:right">Create</a>
    </div>
</div>
<br/>
<div class="row">
                                                ...
                                                <table id="datatable" class="table table-striped table-bordered">
                                                    ...
                                                    <?php $sl=0; ?>
                                                       ...
                                                       <tr>
                                                        ...
                                                        <td>
                                                            <a href="view-salary/{{ $sal->id }}"><i class="fa fa-eye"></i></a>
...
function removeSalary(id) {
    if(confirm("Are you sure to delete?")) {
        window.location="remove-salary/"+id;
    }
}
</script>
