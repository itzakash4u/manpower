...
<div class="row">
    <div class="col-md-12" style="float:right">
        <button class="btn btn-success btn-sm" style="float:right" data-toggle="modal" data-target="#addCategory">Add User</button>
    </div>
</div>
<br/>
<div class="row">
                                                ...
                                                <table id="datatable" class="table table-striped table-bordered">
                                                    ...
                                                    <?php $sl=0; ?>
                                                       ...
                                                       <tr>
                                                        ...
                                                        <td>{{ $usr->name }}</td>
                                                        <td>{{ $usr->email }}</td>
                                                        <td>@if($usr->type==1) Data Entry @elseif($usr->type==2) Employee @endif</td>
                                                        <td>
