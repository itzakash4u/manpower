...
@section('main-content')
                        ...
                        <div class="row"  @if(Auth::user()->type==1 || Auth::user()->type==2) style="display:none" @endif>
                            <div class="col-sm-6 col-lg-3">
                                <div class="panel panel-primary text-center">
                                    ...
                                    <div class="panel-body">
                                        <?php $emp=App\Models\Employee::count('eid'); ?>
                                        <h3 class=""><b>{{ $emp }}</b></h3>
                            ...
                            <div class="col-sm-6 col-lg-3">
                                <div class="panel panel-primary text-center">
                                    ...
                                    <div class="panel-body">
                                        <?php $usr=App\Models\User::count('id'); ?>
                                        <h3 class=""><b>{{ ($usr-1) }}</b></h3>
