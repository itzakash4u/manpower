                    ...
                    <div class="col-md-4">
                        <div class="account-information">
                            ...
                            <ul>
                                ...
                                <li>
                                    <a href="{{url('employee-applied-job')}}">
                            ...
                            <form method="post" class="basic-info" action="{{url('update-employee-profile')}}" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Phone</label>
                                            <input type="number" name="phone" value="{{$user->phone}}" class="form-control" placeholder="Your Phone">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="work_type" id="gp" class="form-control" required>
                                    ...
                                    <div class="container" id="group-box" style="display:none">
                                        <div class="element" id="div_1">
                                            <div class="form-group">
                                                <label>Name</label>
                                                <input type="text" class="form-control" name="gpname[]" id="gpname" value="@if(isset($members)) {{$members->name[0]}} @endif">
                                                <label>Phone</label>
                                                <input type="text" class="form-control" name="gpphone[]" id="gpphone" value="@if(isset($members)) {{$members->phone[0]}} @endif">
                                            </div>
                                        </div>
                                        ...
                                        <div class="element" id="div_{{$nxt}}">
                                            <div class="form-group">
                                                <label>Name</label>
                                                <input type="text" class="form-control" name="gpname[]" id="gpname" value="@if(isset($members)) {{$members->name[$i]}} @endif">
                                                <label>Phone</label>
                                                <input type="text" class="form-control" name="gpphone[]" id="gpphone" value="@if(isset($members)) {{$members->phone[$i]}} @endif">
                                                <br/>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="acc_holder" value="{{$user->ac_holder_name}}" class="form-control" placeholder="">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Account Number</label>
                                            <input type="number" name="ac_number" value="{{$user->ac_number}}" class="form-control" placeholder="">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>IFSC Code</label>
                                            <input type="text" name="ifsc" value="{{$user->ifsc}}" class="form-control" placeholder="">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
