                        ...
                        <div class="job-card-two">
                            <div class="row align-items-center">
                                ...
                                <div class="col-md-8">
                                    <div class="job-info">
                                        <h3>
                                            <a href="job-details.html"><!--Web Designer, Graphic Designer, UI/UX Designer-->{{ $cat->category_name }} </a>
                                        </h3>
                                        <ul>                                          
                                            <li>
                                            ...
                                            <li @if(empty($job->no_of_assignment)) style="display:none" @endif>
                                                <!-- <i class='bx bx-location-plus'></i> -->
                                                <!--Wellesley Rd, London-->{{$job->no_of_assignment}} assignment
                                            </li>
                                            <li @if(empty($job->job_duration)) style="display:none" @endif>
                                                <!-- <i class='bx bx-location-plus'></i> -->
                                                <!--Wellesley Rd, London-->{{$job->job_duration}} hours
                                            </li>
                                            <li>
                                                <!-- <i class='bx bx-location-plus'></i> -->
                                                {{$job->job_id}}
