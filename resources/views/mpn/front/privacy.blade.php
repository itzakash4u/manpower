...
@section('add-metatags')
        <title>Privacy Policy | Manpower Nation</title>
        <meta name="description" content="Read our privacy policy carefully to understand how we use and protect your personal information when you use our human resources supply services." />
@stop
        ...
        <section class="page-title title-bg10">
            <div class="d-table">
                <div class="d-table-cell">
                    <h2>Privacy Policy for Manpower Nation</h2>
                    <ul>
                        <li>
                            <a href="{{url('/')}}">Home</a>
                        </li>
            ...
            <div class="container">
                <div class="about-text">
                    ...
                    <ul type="square">
                        ...
                        <li><strong>Company </strong>(referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Manpower Nation, B1/63/12/New Budge Budge Trunk Road, Jagtala (West) PO Batanagar, PS Mehestala Pin code-700 141.</li>
                        ...
                        <li><strong>Website </strong>refers to Manpower Nation, accessible from https://manpowernation.com/</li>
                    ...
                    <ul type="square">
                        <li>By email: customersupport@manpowernation.com</li>
                        <li>By visiting this page on our website: manpowernation.com</li>
                    </ul>
                </div>
            </div>
        </section>
