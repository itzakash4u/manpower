...
@section('main-content')
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 col-lg-3">
                                <div class="panel panel-primary text-center">
                                    <div class="panel-heading">
                                        <h4 class="panel-title">Number of Job Post</h4>
                                    </div>
                                    <div class="panel-body">
                                        <h3 class=""><b>{{$tot_job}}</b></h3>
                            ...
                            <div class="col-sm-6 col-lg-3">
                                <div class="panel panel-primary text-center">
                                    <div class="panel-heading">
                                        <h4 class="panel-title">Ongoing Jobs</h4>
                                    </div>
                                    <div class="panel-body">
                                        <h3 class=""><b>{{$ongoing}}</b></h3>
                            ...
                            <div class="col-sm-6 col-lg-3">
                                <div class="panel panel-primary text-center">
                                    <div class="panel-heading">
                                        <h4 class="panel-title">Job Completed</h4>
                                    </div>
                                    <div class="panel-body">
                                        <h3 class=""><b>{{$completed}}</b></h3>
