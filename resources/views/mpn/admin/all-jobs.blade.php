...
<div class="row">
                                            ...
                                            <div class="col-md-12 col-sm-12 col-xs-12">
                                                <table id="datatable" class="table table-striped table-bordered">
                                                    ...
                                                    <?php $sl=0; ?>
                                                       @if($jobs)
                                                       @foreach($jobs as $job)
                                                       <?php $sl++; $cat=\App\Models\Category::find($job->cat_id); $user=\App\Models\User::find($job->user_id); ?>
                                                       <tr>
                                                        <td>{{ $sl }}</td>
                                                        <td>{{ $job->title }}</td>
                                                        <td>{{ $job->job_id }}</td>
                                                        <td>
                                                            ...
                                                            <p>Email: @if(isset($user)) {{ $user->email }} @endif</p>
                                                        ...
                                                        <td>{{ ($job->req_cancel==1)?'Customer Requested to Cancel this Job':'NA' }}</td>
                                                        <td>
                                                            <a href="{{url('admin-view-job-details')}}/{{$job->id}}" class="btn btn-primary btn-sm">View Job</a>
                        ...
                        <div class="modal fade" id="editCategory{{$job->id}}">
                            <div class="modal-dialog">
                                ...
                                <form method="post" action="{{url('/admin-edit-job')}}">
                                        @csrf
