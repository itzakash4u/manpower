...
<div class="row">
    <div class="col-md-12">
        <button type="button" tada-toggle="modal" data-target="#blogModal" class="btn btn-success">Add Blog</button>
    </div>
</div>
<div class="row">
                            <div class="col-md-12">
                                                ...
                                                <table id="datatable" class="table table-striped table-bordered">
                                                    ...
                                                    <?php $sl=0; ?>
                                                       ...
                                                       <tr>
                                                        ...
                                                        <td>
                                                            <a href="javascript:void(0)" data-toggle="modal" data-target="#blogEditModal{{$blog->id}}"><i class="fa fa-edit"></i></a>
