            ...
            <div class="topbar">
                ...
                <div class="topbar-left">
                    <div class="text-center">
                        <a href="index.html" class="logo"><img src="{{asset('media/manpower.png')}}" width="175" height="55"></a>
                    ...
                    <div class="container">
                        <div class="">
                            ...
                            <ul class="nav navbar-nav navbar-right pull-right">
                                ...
                                <li class="dropdown">
                                    <a href="" class="dropdown-toggle profile waves-effect waves-light" data-toggle="dropdown" aria-expanded="true"><img src="@if(!empty(Auth::user()->profile_image)) {{ asset('media/profile/'.Auth::user()->profile_image) }} @else {{ asset('media/admin.png') }} @endif" alt="admin-img" class="img-circle"> </a>
